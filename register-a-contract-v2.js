...
module.exports = register_a_contract2;
...
async function register_a_contract2(o) {
  const {verbose, package_id, app_folder,
    districts_folder, students_folder, agencies_folder, schools_folder,
    district_id, agency_id, student_id,
    _index // yaml_index
  } = o;
  /*
  ...
  */
  ...
  _assert('district_id package_id app_folder contract_number'.split(/\s+/),o);
  ...
  *******************************************/
  ...
  if (!contract_id) {
    ...
    console.log(`added new folder:${contract_id} for ${contract_number}`)
  }
